<template>
  <div class="flex">
      <div class="h-screen">
        ...
        <h2 class="text-3xl font-extrabold text-gray-800 dark:text-white text-center">SAMUEL</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="../../../app/Images/avatar.jpg">
      ...
      <div class="w-full bg-blue-100 flex justify-between flex-col">
          <div class="bg-green-500">
            <nav class="bg-white shadow dark:bg-gray-800">
              <div class="container px-6 py-3 mx-auto md:flex">
                  <div class="flex items-center justify-between">
                      <div>
                          <a class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Samuel</a>
                      </div>
